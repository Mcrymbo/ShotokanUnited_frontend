...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden shadowed-md bg-white duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${
        sidebarOpen ? 'translate-x-0' : '-translate-x-full'
      }`}
    >
      {/* <!-- SIDEBAR HEADER --> */}
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <div className='border-b-[0.5px] border-orange-300 pb-6'>
        <NavLink to="/admin">
          <img className='w-[50%] h-[50%] mx-auto' src={logo} alt="Logo" />
          <h3 className='text-center text-red-700'>SHOTOKAN-UNITED KENYA</h3>
        </NavLink>
        </div>
