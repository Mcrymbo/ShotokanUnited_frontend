  ...
  return (
    <DefaultLayout>
        <div className='relative'>
            <img src={k_flag} alt="suk" width={20} height={30} className='w-full'/>
            <div className="bg-black opacity-20 absolute inset-0"></div>
            <h1 className='absolute bottom-0 left-0 text-white font-semibold p-6 md:text-4xl'>Affiliate your club with HDKI-Kenya</h1>
        </div>
        <div className='container flex flex-col md:flex-row justify-center gap-8 mt-8 lg:py-10 my-4 lg:px-20'>
            <div className='space-y-4'>
                ...
                <article>
                    ...
                    <span className='text-bold'>Goodric Musoga, Technical Director</span> of Association at <span className='text-bold text-red-500 italic'>gmusoga@gmail.com</span>
                </article>

            </div>
            <img src={jos_mus_jka} alt="affiliation" width={20} height={30} className='w-full md:w-1/3 object-cover'/>
        </div>
