            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div className="pt-2">
                <input
                  ...
                  className="w-full py-3 bg-orange-500 text-white rounded-lg shadow-lg 
                    cursor-pointer transition hover:bg-orange-600 
              ...
              <button className="w-full flex items-center justify-center gap-2 p-3 
                ...
                transition hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-orange-500">
                <svg
                  width="20"
                  height="20"
                  viewBox="0 0 20 20"
