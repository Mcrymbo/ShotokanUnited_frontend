    ...
    <div>
        <div className='flex flex-col md:flex-row justify-center items-center flex-wrap gap-4 mt-8'>
            {Excommitee.map((item, index) => (
                <div key={index} className='flex flex-col w-full shadow-md p-2'>
                    <img src={item.photo} alt="img" width={40} height={40} className='w-full md:w-[200px] md:h-[160px] object-cover rounded-md bg-gray-300' />
