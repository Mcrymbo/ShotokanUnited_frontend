...
function About() {
  return (
    <DefaultLayout>
      ...
      <div id='about-section' className='container  max-w-full bg-inherit p-4 md:py-10'>

        {/* Hero Image Section */}
        <div className="relative w-full mb-8">
          <img
            src={suk_team}
            alt="about shotokan united karate kenya"
            className='w-full h-[200px] md:h-[300px] lg:h-[400px] xl:h-[500px]  object-cover' // Adjusted for better scaling across screens
          />
        ...
        <section>
          {/* About Us Text & Image */}
            <div className='flex flex-col lg:flex-row lg:space-x-10 lg:py-10 my-4 lg:px-20'>
                <article className='flex flex-col gap-4 text-lg text-left mb-8 lg:mb-0'> {/* Added lg:mb-0 to remove bottom margin on large screens */}
                    <p>
                ...
                <img src={jka_rwanda} alt="about"
                  ...
                  className='rounded-md w-full md:w-auto md:h-[60vh] lg:h-[70vh] xl:h-[80vh] object-contain'
                  />
                {/* Adjust widths for different screens and make image contain */}
            </div>
            ...
            <div className='bg-blue-50 -mx-4 mb-8 px-4 py-8 lg:px-20'>
                        ...
                        <div className='flex justify-between flex-col md:flex-row lg:space-x-4'>
                            <div className="mb-4 md:mb-0 w-full md:w-1/2"> {/* Added md:w-1/2  and lg:w-auto for smaller screens*/}
                            ...
                            <div className="mb-4 md:mb-0 w-full md:w-1/2">
                                <h3 className='text-l font-bold py-4'>Cooperation</h3>
            ...
            {/* Karate Empowering Communities */}
            <div >
                <div className='lg:flex lg:space-x-8 lg:justify-center items-center lg:mx-10'>
                        <div className='bg-gray-300 rounded-md justify-start shadow-sm lg:w-1/2'>
