  ...
  return (
    <div>
      <div className="mx-auto max-w-screen-xl text-center py-10 px-4 sm:px-6 lg:px-8">
        ...
        <div className="carousel carousel-center bg-neutral rounded-box max-w-full space-x-4 p-4 overflow-x-auto">
          {commitee.map((member, index) => (
            <div key={index} className="carousel-item w-full sm:w-auto">
              <div className="flex flex-col items-center">
                <img
                  src={member.photo}
                  className="rounded-md w-full sm:w-60 h-auto object-cover"
                />
